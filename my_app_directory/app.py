...
from routes import hazard_management_bp, inventory_bp, job_intake_bp, auth_bp, account_bp, admin_bp, individual_cleaner_bp
...
def create_app():
    ...
    app.register_blueprint(individual_cleaner_bp)
